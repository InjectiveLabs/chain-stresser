...
func NewClientWithOpts(endpoint string, opts *RPCClientOpts) RPCClient {
	...
	if opts.LogEverything {
		rpcClient.logEverything = true
	}

	if opts.Logger != nil {
		rpcClient.logger = opts.Logger
	}
...
func (client *rpcClient) newRequest(ctx context.Context, req interface{}) (*http.Request, error) {
	...
	if client.logEverything && client.logger != nil {
		client.logger.Infoln("JSONRPC Request: ", string(body), " -> ", client.endpoint)
	}
...
func (client *rpcClient) doCall(ctx context.Context, RPCRequest *RPCRequest) (*RPCResponse, error) {
	...
	respBody, err := ioutil.ReadAll(io.LimitReader(httpResponse.Body, 1024*1024*1024))
	...
	if client.logEverything && client.logger != nil {
		client.logger.Infoln("JSONRPC Response: ", httpRequest.URL.String(), " -> ", string(respBody))
	}
