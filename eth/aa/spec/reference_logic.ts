import {
  ...
  import EntryPointSimulationsJson from '../artifacts/eth/core/EntryPointSimulations.sol/EntryPointSimulations.json'
  import { ethers } from 'hardhat'
  import { IEntryPointSimulations } from '../typechain/eth/core/EntryPointSimulations'
  ...
  export async function fillAndSign (op: Partial<UserOperation>, signer: Wallet | Signer, entryPoint?: EntryPoint, getNonceFunction = 'getNonce'): Promise<UserOperation> {
    ...
    console.log('op2=', op2, 'signature=', signature)
    return {
      ...op2,
      signature
    }
