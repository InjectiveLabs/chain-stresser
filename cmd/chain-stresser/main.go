...
func main() {
	...
	txnsReplayCmd.Flags().Float64Var(&stressCfg.GasFuzzing.GasPriceMultiplierMin, "gas-price-min", 0.01, "Minimum gas price multiplier.")
	txnsReplayCmd.Flags().Float64Var(&stressCfg.GasFuzzing.GasPriceMultiplierMax, "gas-price-max", 1.0, "Maximum gas price multiplier.")
