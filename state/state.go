...
type StateConfig struct {
	...
	StartHeight    int    `yaml:"startHeight" arg:"--start-height" help:"block height to start sniffing transactions from"`
	EndHeight      int    `yaml:"endHeight" arg:"--end-height" help:"block height to end sniffing transactions from, optional. 0 = do not stop"`
